...
?>
    ...
    <div class="col-xs-12" id="profile_business_info">
        <br><br><h4>BUSINESS INFORMATION</h4><hr>
        <?php
        ...
        <form class="row">
            <div class="col-xs-12 col-sm-6">
                <br>
                <label for="p_business_name">Business Name</label>
                <input id="p_business_name" type="text" class="form-control" disabled placeholder="Business Name">
            </div>
            <div class="col-xs-12 col-sm-6">
                <br>
                <label for="p_business_cat">Business Category</label>
                <input id="p_business_cat" type="text" class="form-control" disabled placeholder="Business Category">
            </div>
            <div class="col-xs-12">
                <br>
                <label for="p_business_descr">Business Description</label>
                <textarea id="p_business_descr" class="form-control" placeholder="Business Description"></textarea>
            </div>
            <div class="col-xs-12 pull-right">
                <br>
