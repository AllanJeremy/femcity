...
$(document).ready(function(){
    ...
    function UpdateRegionList($country_list)
    {
        ...
        //If the country list is in the root file ~ update the ajax path to correspond to that
        if($country_list.hasClass("root_file"))
        {
          ajax_handler_path = "./handlers/ajax_handler.php";
        }

        //If the region list could be found
